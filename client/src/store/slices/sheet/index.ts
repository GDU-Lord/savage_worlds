...
const reducers = combineReducers({ sheet, attributes, skills, other, derived, armor, weapons, tools, edges, hindrances, text, tabs, shields });

export const sheetActions = { ..._sheetActions, ...attributesActions, ...skillsActions, ...otherActions, ...derivedActions, ...armorActions, ...weaponsActions, ...toolsActions, ...edgesActions, ...hindrancesActions, ...textActions, ...tabsActions, ...shieldsActions };
